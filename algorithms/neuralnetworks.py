...
def L_layer_model(X_train, Y_train, X_test, Y_test, layers_dims, learning_rate = 0.0075, num_iterations = 3000):
    ...
    # accuracy =     np.sum((Y_prediction_train == Y_train)/m)
...
# X_train, X_test, y_train, y_test = loadDataset('class',2,.33)
# # print(len(layers_dims))
# # m = X_train.shape[1]

# layers_dims = [X_train.shape[1], 20, 7, 5, 1]
# d = L_layer_model(X_train.T,y_train.T,X_test.T,y_test.T,layers_dims,.0075,2500)
